 ...
 <footer className="border-t border-gray-200 bg-white pt-16 pb-8 px-4 sm:px-8 md:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <h4 className="font-bold text-gray-900 mb-3 text-sm uppercase">Download Our App</h4>
            <div className="flex flex-col sm:flex-row gap-3">
              {/* Play Store Badge */}
              <a href="#" className="flex items-center justify-center gap-2 bg-black text-white px-3 py-1.5 rounded-lg hover:bg-gray-800 transition-colors w-max">
