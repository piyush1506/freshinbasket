        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a 
                ...
                aria-label="Download Freshinbasket on Google Play Store" 
                className="flex items-center justify-center gap-2 bg-black text-white px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors w-max min-h-[44px]"
              >
              ...
              {/* App Store Badge */}
              <button 
                onClick={() => alert("iOS App is currently under review on the Apple App Store. Coming soon!")}
                aria-label="Freshinbasket on Apple App Store (Coming Soon)" 
                className="flex items-center justify-center gap-2 bg-black text-white px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors w-max min-h-[44px] cursor-pointer"
              >
                ...
                <div className="text-left">
                  <div className="text-[8px] uppercase tracking-wider leading-none">COMING SOON ON</div>
          ...
          <nav aria-label="Quick links">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="https://play.google.com/store/apps/details?id=in.freshinbasket.app&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" className="hover:text-green-600 transition-colors font-semibold text-green-700 flex items-center gap-1.5">📱 Download Android App</a></li>
              ...
              <li><Link href="/refund-policy" className="hover:text-green-600 transition-colors">Refund & Return Policy</Link></li>
