            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={`relative w-full overflow-hidden text-white py-3.5 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 shadow-md hover:shadow-lg active:scale-[0.98] ${
                    isProcessing ? "bg-[#1a4d32] cursor-not-allowed" : "bg-[#216140] hover:bg-[#1a4d32] disabled:opacity-70 disabled:cursor-not-allowed"
                  }`}
                >
                  {isProcessing ? (
                    <div className="flex items-center gap-3">
                      ...
                      <span className="animate-pulse tracking-wide">Processing...</span>
                    </div>
                  ) : (
                    <>
                      <Lock size={18} />
                      {paymentMethod === "cod" ? `Place COD Order - ₹${parseInt(grandTotal)}` : `Confirm & Pay - ₹${parseInt(grandTotal)}`}
                    </>
                  )}
                </button>
              </div>
